    ...
    <div className="py-8">
      ...
      <div className="p-16 w-[75%] mx-auto bg-white">
        ...
        <p className="my-4 text-3xl">
          <b className="text-[#00ADB5]">Virtual Reality Marketing Agency</b> is
          ...
          <b className="text-[#00ADB5]">engaging</b>,{" "}
          <b className="text-[#00ADB5]">interactive content</b> that stands out
          in competitive industries such as{" "}
          <b className="text-[#00ADB5]">real estate</b>,{" "}
          <b className="text-[#00ADB5]">agriculture</b>,
          <b className="text-[#00ADB5]">fashion</b>, and{" "}
          <b className="text-[#00ADB5]">professional services</b>.
        </p>
      </div>
      <div className="p-4 w-[75%] mx-auto">
        ...
        <ul className="flex flex-wrap justify-evenly">
          {coreValues.map((coreValue, index) => (
            ...
            >
              <h4 className="text-3xl py-2 text-[#00ADB5]">
                {coreValue.value}
              </h4>
